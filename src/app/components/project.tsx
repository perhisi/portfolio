      ...
      <section id="projects" className="py-16 sm:py-20 lg:py-24 section-hover">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <div className="w-20 h-1 bg-gradient-to-r from-indigo-500 to-teal-500 mx-auto rounded-full"></div>
          </div>

          {/* <!-- Projects Grid --> */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 lg:gap-8">
            {/* <!-- Project 1 --> */}
            <div className="project-card bg-white dark:bg-slate-800 rounded-2xl shadow-lg overflow-hidden flex flex-col group">
              ...
              <div className="p-5 sm:p-6 flex flex-col flex-1">
                <h3 className="text-lg sm:text-xl font-semibold mb-3 text-slate-800 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors duration-300">
                  Portfolio Website
                </h3>
                <div className="flex flex-wrap gap-2 mb-3">
                  <span className="badge bg-indigo-100 dark:bg-indigo-900/50 text-indigo-700 dark:text-indigo-300 text-xs px-2 py-1 rounded-lg">
                    HTML
                  </span>
                  <span className="badge bg-indigo-100 dark:bg-indigo-900/50 text-indigo-700 dark:text-indigo-300 text-xs px-2 py-1 rounded-lg">
                    CSS
            ...
            <div className="project-card bg-white dark:bg-slate-800 rounded-2xl shadow-lg overflow-hidden flex flex-col group">
              ...
              <div className="p-5 sm:p-6 flex flex-col flex-1">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400 mb-4 flex-1">
                  ...
                  featuring role-based access control, dynamic course
            ...
            <div className="project-card bg-white dark:bg-slate-800 rounded-2xl shadow-lg overflow-hidden flex flex-col group">
              ...
              <div className="p-5 sm:p-6 flex flex-col flex-1">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400 mb-4 flex-1">
                  ...
                  authentication, secure CRUD operations, and robust data
                  validation.
                  <br />
                  <span className="italic text-indigo-600 dark:text-indigo-400">
                    Role: Backend Developer
            ...
            <div className="project-card bg-white dark:bg-slate-800 rounded-2xl shadow-lg overflow-hidden flex flex-col group">
              <div className="relative overflow-hidden">
                <Image
                  src="/icons/project-5/Screenshot 2026-05-10 110202.png"
                  alt="WeRent Backend System"
                  width={600}
                  height={192}
                  style={{ width: "auto", height: "auto" }}
                  className="w-full h-40 sm:h-48 object-cover group-hover:scale-110 transition-transform duration-500"
              ...
              <div className="p-5 sm:p-6 flex flex-col flex-1">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400 mb-4 flex-1">
                  ...
                  access control, and comprehensive booking & payment logic.
                  <br />
                  <span className="italic text-indigo-600 dark:text-indigo-400">
            ...
            <div className="project-card bg-white dark:bg-slate-800 rounded-2xl shadow-lg overflow-hidden flex flex-col group">
              ...
              <div className="p-5 sm:p-6 flex flex-col flex-1">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400 mb-4 flex-1">
                  Production-grade e-commerce backend for dietary products and
                  supplements targeting breastfeeding mothers. Features
                  enterprise-level architecture with 30+ database migrations,
                  AI-powered product recommendations, and comprehensive payment
                  integrations.
                  <br />
                  <span className="italic text-indigo-600 dark:text-indigo-400">
                    Role: Backend Engineer
